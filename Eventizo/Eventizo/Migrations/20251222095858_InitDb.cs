    ...
    public partial class InitDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PendingPaymentSeats", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedUserMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EncryptedBotReply = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventEndingDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    PriceReducedMin = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PriceMax = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PriceReducedMax = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteVotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteVotes_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatPrices = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransferRequestedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NewOwnerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    PreviousOwnerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsVisibleToPreviousOwner = table.Column<bool>(type: "bit", nullable: false),
                    TransferStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    IsTransferAccepted = table.Column<bool>(type: "bit", nullable: true),
                    TransferNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderCode = table.Column<long>(type: "bigint", nullable: false),
                    TransferOrderCode = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_AspNetUsers_NewOwnerId",
                        column: x => x.NewOwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tickets_AspNetUsers_PreviousOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payment2s", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Payment2s_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payment2s_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteVotes_EventId",
                table: "FavoriteVotes",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_Payment2s_ProductId",
                table: "Payment2s",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Payment2s_UserId",
                table: "Payment2s",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_NewOwnerId",
                table: "Tickets",
                column: "NewOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_PreviousOwnerId",
                table: "Tickets",
